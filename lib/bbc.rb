...
class BBC
	...
	def articles text="", product, published_after, sections="", category
		juicer.articles({text: text, product: product, published_after: published_after, sections: sections}) # "BBC News - Africa, BBC Sport - Football"
		if !articles.empty?
